...
// --- Config réseau ---
const char* DEFAULT_WIFI_SSID = "Nom_Du_Wifi";
const char* DEFAULT_WIFI_PASSWORD = "Mot_De_Passe_Wifi"; // peut etre "" pour vide 
